...
import v1rootRouter from "./src/eduxl/routers/index.js";
...
export function calculateTransactionFee(amount) {
  // Calculate the fee at 1.5%
  const fee = amount * 0.015;

  // Return the lesser of the calculated fee or the ₦250 cap.
  return fee > 250 ? 250 : fee;
}
